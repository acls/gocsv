...
func Test_writeTo_slice_structs(t *testing.T) {
	...
	assertLine(t, []string{"s_0_s", "s_0_f", "s_1_s", "s_1_f", "ints_0", "ints_1", "ints_2", "a_0_s", "a_0_f", "a_1_s", "a_1_f"}, lines[0])
...
func Test_writeTo_nested_struct(t *testing.T) {
	...
	assertLine(t, []string{"one.boolField1", "one.stringField2", "two.boolField1", "two.stringField2"}, lines[0])
	assertLine(t, []string{"false", "email_one", "true", "email_two"}, lines[1])
}
